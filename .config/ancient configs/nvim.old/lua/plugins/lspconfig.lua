  ...
  },
  {
    ...
    config = function()
      ...
      lspconfig.fortls.setup({
        capabilities = capabilities,
        root_dir = vim.lsp.config.util.root_pattern("*.f90"),
      })
      ...
      lspconfig.ols.setup({
        capabilities = capabilities,
        root_dir = vim.lsp.config.util.root_pattern("*.odin"),
      })
      lspconfig.ocamllsp.setup({
        capabilities = capabilities,
        cmd = { "ocamllsp", "--stdio" },
        filetypes = { "ocaml", "reason" },
        root_dir = vim.lsp.config.util.root_pattern("*.opam", "esy.json", "package.json"),
      })
      ...
      vim.lsp.config.clangd.setup({
        ...
        root_dir = vim.lsp.config.util.root_pattern("src"),
      ...
      lspconfig.rescriptls.setup({
        ...
        root_dir = vim.lsp.config.util.root_pattern("rescript.json"),
      })
      ...
      lspconfig.julials.setup({
        ...
        root_dir = vim.lsp.config.util.root_pattern("*.jl"),
      })
      lspconfig.c3_lsp.setup({
        capabilities = capabilities,
        cmd = { "c3lsp" },
        root_dir = vim.lsp.config.util.root_pattern({ "project.json", "*.c3" }),
      })
